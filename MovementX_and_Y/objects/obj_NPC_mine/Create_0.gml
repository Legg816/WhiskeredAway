...
{
	myText[0] = "A cat walking around on two legs? I must be spending too much time in the mines..."
	myText[1] = "Anyways, the name is Smokey Joe, and these here mines are where we get the ores to power the town's magic!"
	myText[2] = ["Now answer me this, what would a cat want here?", ">1. Meow meow.", ">2. Meow MEOW!!!"]
